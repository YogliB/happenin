...
| `src/UI/dashboard/components/*.ts` | Focused renderers for header, filters, metric cards, event-frequency SVG chart, tool-usage CSS bars, context breakdown bars, sessions table, and detail panel. |
